...
TOOL_REGISTRY: dict[str, ToolMeta] = {
    ...
    "KillProcess":      ToolMeta(tier=3, category="system"),
    "RegWrite":         ToolMeta(tier=3, category="system"),
    "ServiceStart":     ToolMeta(tier=3, category="system"),
    "ServiceStop":      ToolMeta(tier=3, category="system"),
    "TaskCreate":       ToolMeta(tier=3, category="system"),
    "TaskDelete":       ToolMeta(tier=3, category="system"),
    "SetClipboard":     ToolMeta(tier=3, category="system"),
